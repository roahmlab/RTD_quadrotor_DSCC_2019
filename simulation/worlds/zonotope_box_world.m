...
properties
    ...
    N_long = 5 ;
    N_boxy = 15 ;
    obs_tall_size_range = [0.25, 1] ; % [min,max] thickness
    obs_wide_size_range = [0.25, 1] ; % [min,max] thickness
    obs_long_size_range = [0.25, 1] ; % [min,max] thickness
    obs_boxy_size_range = [0.25, 5, 3, 3] ; % [min,max,mean,std] side length
    ...
    plot_ground_opacity = 0.9 ;
    plot_ceiling_color = [0.9 0.9 1] ;
    plot_ceiling_opacity = 0 ;
    plot_wall_color = [0.5 0.5 0.5] ;
    plot_wall_opacity = 0.05 ;
    
    plot_goal_zone_color = [0 1 0.5] ;
    plot_goal_zone_opacity = 0.1 ;
    plot_start_zone_color = [0.6 0 0.7] ;
    plot_start_zone_opacity = 0.1 ;
